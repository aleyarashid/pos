                    ...
                    <form @submit.prevent="submit">
                        <div class="card-body">
                            ...
                            <div class="container-fluid m-0 p-0">
                                ...
                                <div class="row m-0 p-0">
                                    <div class="col-md-4 p-2">
                                        <button type="submit" href="loginForm.html"  class="btn mt-3 w-100  btn-success">Complete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
function submit(){
    if(form.name.length === 0){
        ...
        toaster.warning("Please Enter Confirm Password");
    }
    else if(form.password !== form.cpassword){
        toaster.warning("Password and Confirm Password must be same");
    }
    else{
        form.post("/user-registration", {
            onSuccess: () => {
                ...
                {
                    router.get("/login");
                    toaster.success('Registration Successfully');
                }
                else
                {
